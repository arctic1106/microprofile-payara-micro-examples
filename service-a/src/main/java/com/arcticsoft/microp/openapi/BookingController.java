package com.arcticsoft.microp.openapi;
...
public class BookingController
{
	...
	{
		return Response.status(Response.Status.OK).entity(Booking.booking(bookingId, Destination.destination("New Rearendia", "Wheeli"))).build();
	}
}